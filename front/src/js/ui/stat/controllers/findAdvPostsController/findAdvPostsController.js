    ...
    .controller('findAdvPostsController', ['$rootScope', '$scope', '$state', 'bus', 'vkApiFactory', 'appState',
        ...
        function ($rootScope, $scope, $state, bus, vkApiFactory, appState, $timeout, memoryFactory, radCommonFunc,
                    ...
                    function getWall() {
                        ...
                        vkApiFactory.getWall(authData, {
                            ...
                            if (res && res.length > 1) {
                                ...
                                /*wallStat = wallStat.filter((post)=> {
                                 return post.marked_as_ads || post.text.indexOf("http://") > -1
                                 || post.text.indexOf("https://") > -1;
                                 });*/
            ...
            function refreshPostList(list){
                ...
                for (var i = 0; i < 20; i++) {
                    if (list[i])
                        $scope.wallListView.push(list[i]);
                    else i = 20;
                }
