$(function(){
  ...
  function updateHeight(){
    if(!$("#cl-wrapper").hasClass("fixed-menu")){
      ...
      $('.cl-vnavigation li > a').on('click', function (e) {
        ...
        parent.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('a').children('.arrow').removeClass('open');
        parent.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('a').children('.arrow').removeClass('active');
        parent.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('.sub-menu').slideUp(200);
    ...
    if ($('#cl-wrapper').hasClass('sb-collapsed')) {
        ...
        elem.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('a').children('.arrow').removeClass('open');
        elem.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('a').children('.arrow').removeClass('active');
        elem.children('li.open.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/li.open*/).children('.sub-menu').slideUp(0);
  ...
  $('.nav-tabs').on('shown.bs.tab.htm'/*tpa=http://www.condorthemes.com/flatdream/js/behaviour/shown.bs.tab*/, function (e) {
    $(".nscroller").nanoScroller();
  });
