        ...
        return this.each(function() {
            ...
            function upOnce() {
                ...
                if (value > settings.max) {
                    stopSpin();
                    value = settings.max;
                    originalinput.trigger("touchspin.max.htm"/*tpa=http://www.condorthemes.com/flatdream/js/bootstrap.touchspin/bootstrap-touchspin/touchspin.max*/);
                }
            ...
            function downOnce() {
                ...
                if (value < settings.min) {
                    stopSpin();
                    value = settings.min;
                    originalinput.trigger("touchspin.min.htm"/*tpa=http://www.condorthemes.com/flatdream/js/bootstrap.touchspin/bootstrap-touchspin/touchspin.min*/);
                }
