    ...
    {analytics && !isLoadingAnalytics && <>
      <div className="span-2 analytics-section-switcher">
        {analytics.platform === 'youtube'
          ...
          : <SegmentedControl selectedId={analyticsSection} size={40} onChange={(id) => setAnalyticsSection(id as AnalyticsSection)}><Segment id="summary" title="Сводная" /><Segment id="audience" title="Аудитория" /><Segment id="posts" title="Посты" /></SegmentedControl>}
      </div>
