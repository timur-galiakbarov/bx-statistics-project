...
$.extend( $.fn.dataTableExt.oPagination, {
	"bs_normal": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			var els = $('a', nPaging);
			$(els[0]).bind( 'click.DT.htm'/*tpa=http://www.condorthemes.com/flatdream/js/jquery.datatables/bootstrap-adapter/js/click.DT*/, { action: "previous" }, fnClickHandler );
			$(els[1]).bind( 'click.DT.htm'/*tpa=http://www.condorthemes.com/flatdream/js/jquery.datatables/bootstrap-adapter/js/click.DT*/, { action: "next" }, fnClickHandler );
		},
